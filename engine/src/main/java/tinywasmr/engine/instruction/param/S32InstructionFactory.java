...
public class S32InstructionFactory implements FixedOpcodeInstructionFactory {
	@FunctionalInterface
	...
	public S32InstructionFactory(int opcode, String name, I32Executor executor) {
		this.opcode = opcode;
		this.name = name;
		this.executor = executor;
	}
	...
	public Instruction parse(LEDataInput in) throws IOException {
		return new I32Instruction((int) in.readLEB128Signed(32), name, executor);
	}
